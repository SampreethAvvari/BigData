...
def main(spark, file_path):
    ...
    print(f'Minimum Time taken to run Basic Query 5 times on {file_path}:{min(times)}')
    print(f'Median Time taken to run Basic Query 5 times on {file_path}:{statistics.median(times)}')
